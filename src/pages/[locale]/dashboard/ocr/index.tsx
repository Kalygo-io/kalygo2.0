          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                {t("dashboard-page:ocr.title")}
              </h2>
              <p className="mt-1 text-sm leading-6 text-gray-400">
                &apos;OCR&apos; allows you to upload a document (.txt or .pdf)
                and extract text data from it regardless of the format.
                Sometimes documents contain text information embedded in images
                for example.
              </p>
            </div>
          </div>
