...
export function NewDocModal(p: P) {
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    >
                      {t("dashboard-page:docs-table.new-doc-modal.title")}
                    </Dialog.Title>
                  </div>
                </div>
                <form
                ...
                >
                  <label className="relative w-full flex flex-col">
                    <span className="mb-3">
                      {t("dashboard-page:docs-table.new-doc-modal.name")}
                    </span>
                    <input
                      {...register("name", {
                        required: true,
                      ...
                      placeholder={
                        t(
                          "dashboard-page:docs-table.new-doc-modal.name-placeholder"
                        )!
                      }
                    />
                  </label>
