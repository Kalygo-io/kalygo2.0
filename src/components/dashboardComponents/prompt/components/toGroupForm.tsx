import { addPromptToAccessGroupFactory } from "@/serviceFactory/addPromptToAccessGroupFactory";
import { removePromptFromAccessGroupFactory } from "@/serviceFactory/removePromptFromAccessGroupFactory";
...
export const ToGroupForm = (p: P) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const request = addPromptToAccessGroupFactory(
        prompt.id,
          ...
          {prompt.PromptsAndAccessGroups?.map((i: any) => (
            ...
            >
              ...
              <XCircleIcon
                ...
                onClick={async () => {
                  console.log("___ --- ___");
                  const request = removePromptFromAccessGroupFactory(
                    prompt.id,
