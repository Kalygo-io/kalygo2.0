...
export function CustomRequestWizard(props: Props) {
  ...
  const steps = [
    { id: 1, name: t("dashboard-page:custom-request-v3.choose-files") },
    { id: 2, name: t("dashboard-page:custom-request-v3.provide-request") },
    { id: 3, name: t("dashboard-page:custom-request-v3.run") },
  ];
