  ...
  return (
    <>
      ...
      <span className="mt-2 isolate inline-flex rounded-md">
        ...
        {job?.progress === 100 && job?.returnvalue?.summaryId && (
          <button
            type="button"
            ...
            onClick={() => {
              router.push(
                `/dashboard/summary?summary-id=${job?.returnvalue?.summaryId}`
              );
            }}
          >
