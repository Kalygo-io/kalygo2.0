...
export function SummariesV3TableAlt(p: P) {
  let { summaries } = p;
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900">
            {t("dashboard-page:index.summaries-v3.title")}
          </h1>
          <p className="mt-2 text-sm text-gray-700">
            {t("dashboard-page:index.summaries-v3.subtitle")}
          </p>
        </div>
      </div>
                ...
                <tr key={summary.id}>
                  ...
                  <td className="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                    <button
                      ...
                      onClick={() => {
                        router.push(
                          `/dashboard/summary-v3?summary-v3-id=${summary.id}`
                        );
                      }}
                    >
                      {t("dashboard-page:index.summaries-v3.table.view")}
