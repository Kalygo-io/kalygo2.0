...
import { addAccountToAccessGroupFactory } from "@/serviceFactory/addAccountToAccessGroup";
...
export function AddMemberToAccessGroupModal(p: P) {
  ...
  const { open, cb, accessGroupId } = p;

  const onSubmit = async (data: any) => {
    try {
      console.log("data", data);

      const request = addAccountToAccessGroupFactory(data.email, accessGroupId);
