...
export function RagRequestWizard(props: Props) {
  ...
  const steps = [
    { id: 1, name: t("dashboard-page:rag.choose-file") },
    { id: 2, name: t("dashboard-page:rag.provide-request") },
    { id: 3, name: t("dashboard-page:rag.review") },
  ];
