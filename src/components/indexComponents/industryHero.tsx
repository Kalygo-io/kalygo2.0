...
export const IndustryHero = (p: P) => {
  ...
  let typewriterCopy: string[] = [];
  let subHeadline: string = "";
  switch (industry) {
    case "medical":
      typewriterCopy = [
        t("landing-page:industries.medical.typewriter-word-1"),
        t("landing-page:industries.medical.typewriter-word-2"),
        t("landing-page:industries.medical.typewriter-word-3"),
        t("landing-page:industries.medical.typewriter-word-4"),
      ];
      subHeadline = t(
        "landing-page:industries.medical.landing-page-subheadline"
      );
      break;
    case "law":
      typewriterCopy = [
        t("landing-page:industries.law.typewriter-word-1"),
        t("landing-page:industries.law.typewriter-word-2"),
        t("landing-page:industries.law.typewriter-word-3"),
        t("landing-page:industries.law.typewriter-word-4"),
      ];
