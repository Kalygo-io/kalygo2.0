...
//     records: any[];
//   };
//   columnDirections: Record<string, ColumnDirection>;
//   setColumnDirections: (column: string, direction: ColumnDirection) => void;
// }
...
//   console.log("recordsFromParent", recordsFromParent.records);
//   console.log("count", recordsFromParent.count);

//   const records = recordsFromParent.records;
//   const count = recordsFromParent.count;
