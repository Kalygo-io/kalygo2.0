...
export function Footer() {
  ...
  const navigation = {
    main: [
      ...
      { name: t("common:footer.terms-of-service"), href: "/terms-of-service" },
    ...
    social: [
      ...
      {
        name: "Twitter",
        href: "https://twitter.com/kalygo_io",
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: "GitHub",
        href: "https://github.com/orgs/Kalygo-io/repositories",
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: "YouTube",
        href: "https://www.youtube.com/channel/UCho0SXnGBfEabvHdvaaz9oQ",
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
